...
### `Sidebar`
 ...
 سایدبار `(Sidebar)` شامل ابزارهای مربوط به اشکال است که می‌توان آن‌ها را انتخاب کرده یا بکشیم (drag کنیم).
...
فقط برای کمک در استایل دهی استفاده شده است. (کمک در بهبود بدلیل دانش کم در css)
